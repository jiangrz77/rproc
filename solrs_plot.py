...
from util import Z2Symbol_dict, Symbol2Z_dict
from solar_rs import logeps_sols, logeps_solr, \
    logeps_sols_dict, logeps_solr_dict
...
class AbundPlot():
    ...
    def load_star(self, star_name='J1158+0734'):
        ...
        col_logeps = [_ in list(Symbol2Z_dict.keys()) for _ in colnames]
        col_elogeps = [_.startswith('e') for _ in colnames]
        ...
        star_Z = np.array([Symbol2Z_dict[_] for _ in star_el])
        star_logeps_dict = {
            Z2Symbol_dict[_z]: 
        ...
        plot_Z = [Symbol2Z_dict[_] for _ in logeps_solr_dict.keys()]
